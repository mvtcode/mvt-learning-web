...
using System.Data;
public partial class ProductCategorys : System.Web.UI.Page
{
    ...
    private void BindataToRptProductCat()
    {
        ...
        DataTable dtb = objCat.getByID(nCat);
        lblCategoryName.Text = dtb.Rows[0]["ProductCategoryName"].ToString();
        Products pc = new Products();
        rptProductHome.DataSource = pc.GetByProductCat(nCat);
