...
public partial class Admin_AdministratorEdit : System.Web.UI.UserControl
{
    ...
    private void LoadData()
    {
        ...
        if (sAction == "edit")
        {
            ...
            txtName.Text = dtb.Rows[0]["ProductCategoryName"].ToString();
        ...
        { 
            case "add":
                ...
                if (obj.insert(sName) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=procat&message=1";
            ...
            case "edit":
                ...
                if (obj.update(nID,sName) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=procat&message=2";
                        Response.Redirect(sUrl);
                    }
                break;
        }
    ...
    {
        string sUrl = "~/Admin/Administrator.aspx?page=procat";
        Response.Redirect(sUrl);
    }
}