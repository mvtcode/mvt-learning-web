<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductCatManager.ascx.cs" Inherits="Admin_AdvManager" %>
        ...
        <div class="full">
            ...
            <div class="panel">
                <div class="title-large" style="width: 100%;">
                    <h2>
                        Products Category Management</h2>
                    <div class="theme">
                    </div>
                    <div class="drop">
                    </div>
                ...
                <div class="content topad">
                    <table class="tabularData">
                        ...
                        <tbody>
                            <asp:Repeater ID="rptProductCat" runat="server" OnItemCommand="rptAdministrator_ItemCommand"
