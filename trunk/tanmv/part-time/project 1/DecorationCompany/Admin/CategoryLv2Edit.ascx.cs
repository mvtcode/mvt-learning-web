...
public partial class Admin_AdministratorEdit : System.Web.UI.UserControl
{
        ...
        { 
            case "add":
                ...
                if (obj.insert(sName) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=lv2&message=1";
            ...
            case "edit":
                ...
                if (obj.update(nID,sName) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=lv2&message=2";
                        Response.Redirect(sUrl);
                    }
                break;
        }
    ...
    {
        string sUrl = "~/Admin/Administrator.aspx?page=lv2";
        Response.Redirect(sUrl);
    }
}