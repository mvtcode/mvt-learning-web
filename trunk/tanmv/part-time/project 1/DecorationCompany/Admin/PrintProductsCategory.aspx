<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintProductsCategory.aspx.cs" Inherits="Admin_PrintProductsCategory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>>Product Category Exception Report</title>
...
<body>
    ...
    <div style="margin: 0 auto; width: 900px;">
        ...
        <div>
            ...
            To datte : <asp:Label ID="lblDateTo" runat="server" Text="Label"></asp:Label><br />
            <br />
            <span style="float: right;padding-right: 300px;">Sold product number <=2</span>
        </div>
        <br />
