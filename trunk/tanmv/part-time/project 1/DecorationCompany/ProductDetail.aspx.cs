...
public partial class ProductDetail : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        lblProductName.Text = dtb.Rows[0]["ProductName"].ToString();
        lblPrice.Text =" $ " + dtb.Rows[0]["Price"].ToString();
        img.ImageUrl = "~/images/products/" + dtb.Rows[0]["Images"].ToString();
        lblMaincontent.Text = dtb.Rows[0]["MainContent"].ToString();
        int nProductCat = Convert.ToInt32(dtb.Rows[0]["ProductCategoryID"].ToString());

        //bin data to rptRelated
        Products pc = new Products();
        rptProductHome.DataSource = pc.GetProductRelated(nProductCat);
        rptProductHome.DataBind();
    }
 

    protected void rptProductHome_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
    ...
    protected void rptProductHome_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
    ...
    protected void lbtAddtoCard_Click(object sender, EventArgs e)
    {
