<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintProductsSummary.aspx.cs"
    Inherits="Admin_PrintInvoiceSummary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Report Product Summary</title>
...
<body style="background-color: #fff;">
    ...
    <div style="margin: 0 auto; width: 900px;">
        ...
        <div style="margin: 0; width: 900px; text-align: center; padding-top: 50px; padding-bottom: 20px;">
            <asp:Label ID="Label1" runat="server" Text="PRODUCT  SUMMARY REPORT" Font-Bold="True"
                ...
                <table class="chartData" style="display: none;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblStockAll" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                    </tbody>
                </table>
