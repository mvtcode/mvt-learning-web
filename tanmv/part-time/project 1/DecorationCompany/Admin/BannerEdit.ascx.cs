...
public partial class Admin_AdministratorEdit : System.Web.UI.UserControl
{
    ...
    private void LoadData()
    {
        ...
        if (sAction == "edit")
        {
            ...
            img.ImageUrl = "~/images/Banner/" + dtb.Rows[0]["Images"].ToString();
    ...
    {
        string savePath = Server.MapPath("~/images/Banner/");
        ...
        { 
            case "add":
                ...
                if (obj.insert(sDescription,sURL,sImage,nCat ) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=banner&message=1";
            ...
            case "edit":
                ...
                if (obj.update(nID,sDescription, sURL, sImage, nCat) > 0)
                    {
                        string sUrl = "~/Admin/Administrator.aspx?page=banner&message=2";
                        Response.Redirect(sUrl);
                    }
                break;
        }
    ...
    {
        string sUrl = "~/Admin/Administrator.aspx?page=banner";
        Response.Redirect(sUrl);
    }
}