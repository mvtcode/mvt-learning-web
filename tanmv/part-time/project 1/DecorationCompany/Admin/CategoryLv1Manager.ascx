<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CategoryLv1Manager.ascx.cs" Inherits="Admin_AdvManager" %>
            ...
            <div class="panel">
                ...
                <div class="content topad">
                    <table class="tabularData">
                        ...
                        <tbody>
                            <asp:Repeater ID="rptCatlv1" runat="server" OnItemCommand="rptAdministrator_ItemCommand"
