<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintCustomerDetails.aspx.cs" Inherits="Admin_PrintCustomerDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Report Customer Details</title>
...
<body>
    ...
    <div style="margin: 0 auto; width: 900px;">
        ...
        <div style="margin: 0; width: 900px; text-align: center; padding-top: 50px; padding-bottom: 20px;">
            <asp:Label ID="Label1" runat="server" Text="CUSTOMER DETAIL REPORT" Font-Bold="True"
