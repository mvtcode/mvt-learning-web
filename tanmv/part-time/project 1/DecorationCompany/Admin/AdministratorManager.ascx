<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdministratorManager.ascx.cs" Inherits="Admin_AdministratorManager" %>
            ...
            <div class="panel">
                ...
                <div class="content topad">
                    <table class="tabularData">
                        ...
                        <tbody>
                            <asp:Repeater ID="rptAdministrator" runat="server" OnItemCommand="rptAdministrator_ItemCommand"
